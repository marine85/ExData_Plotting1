...
# plot 2 of 4
plot(data.Feb$Voltage~data.Feb$timestamp, type='l',
     xlim=as.POSIXct(c("2007-02-01 00:00:00","2007-02-03 00:00:00")),
     xlab = "datetime", ylab = "Voltage")
# plot 3 of 4
plot(Sub_metering_1~timestamp,data = data.Feb,type = "l",
     xlim=as.POSIXct(c("2007-02-01 00:00:00","2007-02-03 00:00:00")),
     xlab = "", ylab = "Energy sub metering")
lines(Sub_metering_2~timestamp,data = data.Feb,
      xlim=as.POSIXct(c("2007-02-01 00:00:00","2007-02-03 00:00:00")),
      xlab = "", ylab = "Energy sub metering",col = "red")
lines(Sub_metering_3~timestamp,data = data.Feb,
      xlim=as.POSIXct(c("2007-02-01 00:00:00","2007-02-03 00:00:00")),
      xlab = "", ylab = "Energy sub metering", col = "blue")
legend("topright", c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),
       col = c("black", "red", "blue"), lwd = 1, bty = "n")
# plot 4 of 4
plot(data.Feb$Global_reactive_power~data.Feb$timestamp, type='l',
     xlim=as.POSIXct(c("2007-02-01 00:00:00","2007-02-03 00:00:00")),
